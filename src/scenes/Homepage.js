  ...
  const listPricing = [
    {
      price: 27,
      currencySymbol: "$",
      description: "Lorep ipsum is a common text",
      features: [
        { isChecked: true, content: "testing testing trsting" },
        { isChecked: true, content: "testing testing trsting" },
        { isChecked: true, content: "testing testing trsting" },
        { isChecked: false, content: "testing testing trsting" },
        { isChecked: false, content: "testing testing trsting" },
      ],
    },
    {
            ...
            <div className="hero-inner section-inner">
              <div className="hero-content">
                <Fade bottom delay={500}>
                  <h1 className="mt-0 mb-16">Belajar React JavaScript</h1>
                </Fade>
